...
<div class="card mb-3 px-md-4 ps-0" style="background-color: white">
    <div id="horarioView" class="divisao" style="display: <?php if ($tabela == 'turma') { echo 'block'; } else { echo 'none'; } ?>;">
        <div class="row row-cols-sm-2 row-cols-lg-4 row-cols-xl-5 row-cols-md-3 g-4 mb-2 ps-lg-4 pe-lg-3" style="padding: 20px;">
            ...
            if ($turma == '0') {
                echo '<h5>O aluno não têm nenhuma turma associada, para inserir/ver o horário, associe uma turma ao aluno</h5>';
            } else {
                echo '
                <div class="card-body">
                    <div class="d-flex flex-column align-items-center gap-4">
                        <form id="imageForm" action="' . $arrConfig['url_trata'] . '/trata_horario.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="pagename" class="form-control" name="pagename" value="' . $page_name . '">
                            <input type="hidden" id="id_turma" class="form-control" name="id_turma" value="' . $id_turma . '">
