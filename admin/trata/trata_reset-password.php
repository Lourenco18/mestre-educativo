...
$message_error_email = '';
$message_error_pass = '';
$location = '../login/forgot-password.php';
verfemail_general($email, $location, $pass, $message_error_pass, $message_error_email);
$user_dados = my_query("SELECT id_colaborador, colaborador, email_institucional FROM colaborador WHERE email_institucional = '$email'");
